...
| --- | --- | --- | --- | ---: | --- |
| Python | AST definitions, imports, calls, decorators, and routes | Resolved call graph with optional LSP and SCIP precision | AST taint with assignment, interpolation, call, and sanitizer tracking | 19 (13 positive / 6 negative) | gated |

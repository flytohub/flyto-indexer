...
Plan, gate-check, or validate code changes. Three actions: 1. plan: Analyze a task before starting — returns risk dimensions (0-10), constraints, step-by-step execution plan, and co-change suggestions (files that historically change together with the targets). 2. gate: Check if you can proceed to the next phase. Server-side enforcement blocks skipping required gates. If pass=false, STOP. 3. validate: Run ruff linter + pytest after making changes. Auto-attaches untested change analysis if test...
...
| Input | Type | Required | Default / enum | Purpose |
|---|---|---|---|---|
| `action` | `string` | yes | `&#91;'plan', 'gate', 'validate'&#93;` | Workflow action to perform |
...
Annotations: `readOnlyHint=true, openWorldHint=false`. Definition: [`src/tool_registry/smart_tools.py:182`](https://github.com/flytohub/flyto-indexer/blob/main/src/tool_registry/smart_tools.py#L182).
...
Annotations: `readOnlyHint=false, destructiveHint=false, openWorldHint=false`. Definition: [`src/tool_registry/smart_tools.py:224`](https://github.com/flytohub/flyto-indexer/blob/main/src/tool_registry/smart_tools.py#L224).
...
Annotations: `readOnlyHint=false, destructiveHint=false, openWorldHint=false`. Definition: [`src/tool_registry/smart_tools.py:278`](https://github.com/flytohub/flyto-indexer/blob/main/src/tool_registry/smart_tools.py#L278).
...
Annotations: `readOnlyHint=true, openWorldHint=true`. Definition: [`src/tool_registry/smart_tools.py:338`](https://github.com/flytohub/flyto-indexer/blob/main/src/tool_registry/smart_tools.py#L338).
...
Annotations: `readOnlyHint=true, openWorldHint=true`. Definition: [`src/tool_registry/smart_tools.py:362`](https://github.com/flytohub/flyto-indexer/blob/main/src/tool_registry/smart_tools.py#L362).
...
Annotations: `readOnlyHint=true, openWorldHint=false`. Definition: [`src/tool_registry/smart_tools.py:386`](https://github.com/flytohub/flyto-indexer/blob/main/src/tool_registry/smart_tools.py#L386).
...
Annotations: `readOnlyHint=true, openWorldHint=true`. Definition: [`src/tool_registry/smart_tools.py:413`](https://github.com/flytohub/flyto-indexer/blob/main/src/tool_registry/smart_tools.py#L413).
...
Annotations: `readOnlyHint=true, openWorldHint=true`. Definition: [`src/tool_registry/smart_tools.py:446`](https://github.com/flytohub/flyto-indexer/blob/main/src/tool_registry/smart_tools.py#L446).
...
Annotations: `readOnlyHint=true, openWorldHint=true`. Definition: [`src/tool_registry/smart_tools.py:484`](https://github.com/flytohub/flyto-indexer/blob/main/src/tool_registry/smart_tools.py#L484).
...
Annotations: `readOnlyHint=true, openWorldHint=false`. Definition: [`src/tool_registry/smart_tools.py:512`](https://github.com/flytohub/flyto-indexer/blob/main/src/tool_registry/smart_tools.py#L512).
...
Annotations: `readOnlyHint=true, openWorldHint=false`. Definition: [`src/tool_registry/smart_tools.py:545`](https://github.com/flytohub/flyto-indexer/blob/main/src/tool_registry/smart_tools.py#L545).
...
Annotations: `readOnlyHint=false, openWorldHint=false`. Definition: [`src/tool_registry/smart_tools.py:571`](https://github.com/flytohub/flyto-indexer/blob/main/src/tool_registry/smart_tools.py#L571).
...
Annotations: `readOnlyHint=false, openWorldHint=false`. Definition: [`src/tool_registry/smart_tools.py:594`](https://github.com/flytohub/flyto-indexer/blob/main/src/tool_registry/smart_tools.py#L594).
...
Annotations: `readOnlyHint=false, openWorldHint=false`. Definition: [`src/tool_registry/smart_tools.py:617`](https://github.com/flytohub/flyto-indexer/blob/main/src/tool_registry/smart_tools.py#L617).
...
Annotations: `readOnlyHint=true, openWorldHint=false`. Definition: [`src/tool_registry/smart_tools.py:642`](https://github.com/flytohub/flyto-indexer/blob/main/src/tool_registry/smart_tools.py#L642).
...
Annotations: `readOnlyHint=false, openWorldHint=false`. Definition: [`src/tool_registry/smart_tools.py:660`](https://github.com/flytohub/flyto-indexer/blob/main/src/tool_registry/smart_tools.py#L660).
